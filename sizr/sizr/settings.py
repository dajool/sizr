...
# Django settings for sizr project.
...
ALLOWED_HOSTS = ['sizr.pelicanbay.de', ]
...
SECRET_KEY = 'l$glcaaxjda$x7alt=oofw#fg196av2le$3d4jql1wx=(%qda*'
...
ROOT_URLCONF = 'sizr.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'sizr.wsgi.application'
...
try:
    ...
    print >> stderr, "=================================================="
    print >> stderr, " No local settings file found. This is mandatory. "
    print >> stderr, "=================================================="
    raise inst
